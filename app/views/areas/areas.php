<?php
/**
 * Vocatio - Tus áreas de interés
 * Página generada dinámicamente en PHP a partir de los resultados
 * del perfil vocacional del usuario.
 */

// --- Datos de ejemplo (en producción vendrían de una base de datos o sesión) ---
$areas = [
    [
        'nombre' => 'Tech',
...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $baseUrl; ?>/styles/areas/areas.css">
</head>

<body>

    <!-- ============ Header / Navbar ============ -->
    <header class="navbar-vocatio">
        <div class="container-xxl d-flex justify-content-between align-items-center h-100 px-3">
            <a href="#" class="brand">
                <span class="material-symbols-outlined">explore</span>
                Vocatio
            </a>
            <nav class="d-none d-md-flex gap-4">
                <a href="#" class="nav-link-vocatio">Inicio</a>
                <a href="#" class="nav-link-vocatio active">Carreras</a>
            </nav>
    ...
    <!-- ============ Footer ============ -->
    <footer>
        <div class="container-xxl d-flex flex-column flex-md-row justify-content-between align-items-center py-4">
            <div class="fw-bold mb-3 mb-md-0">Vocatio</div>
            <div class="d-flex gap-4 mb-3 mb-md-0">
                <a href="#">Institucional</a>
                <a href="#">Contacto</a>
                <a href="#">Política de Privacidad</a>
            </div>
            <div class="small" style="color: var(--color-on-surface-variant);">
                &copy; <?php echo $anioActual; ?> Vocatio. Todos los derechos reservados.
            </div>
        </div>
    </footer>
