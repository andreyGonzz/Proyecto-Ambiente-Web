...
<header class="vt-navbar">
    <div class="vt-container d-flex justify-content-between align-items-center vt-navbar-inner">
        ...
        <div class="d-flex align-items-center gap-3">
            <a href="<?= htmlspecialchars(BASE_URL) ?>/app/views/login/login.php" class="vt-link-primary d-none d-md-inline-block">Iniciar sesión</a>
            <a href="<?= htmlspecialchars(BASE_URL) ?>/app/views/login/register.php" class="vt-btn-primary vt-shadow-soft">Registrarse</a>
        </div>
    </div>
</header>