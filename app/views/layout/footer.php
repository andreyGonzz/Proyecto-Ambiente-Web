...
// Ocultar el bloque visual del footer en páginas admin (body con clase vt-admin-page)
$omitFooterVisual = false;
if (!empty($bodyClass) && strpos($bodyClass, 'vt-admin-page') !== false) {
    $omitFooterVisual = true;
}
?>
<?php if (!$omitFooterVisual): ?>
