...
<footer class="vt-footer">
    <div class="vt-container d-flex flex-column flex-md-row justify-content-between align-items-center gap-3 py-4">
        ...
        <div class="d-flex flex-wrap justify-content-center gap-4">
            ...
            <a href="<?= htmlspecialchars(BASE_URL) ?>/app/views/login/login.php" class="vt-footer-link">Contacto</a>
            <a href="<?= htmlspecialchars(BASE_URL) ?>/app/views/login/register.php" class="vt-footer-link">Política de Privacidad</a>
        </div>
